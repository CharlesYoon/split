...
//    
    ...
    var guestsDataSource: GuestsDataSource? = GuestsDataSource()
    var itemsDataSource: ItemsDataSource? = ItemsDataSource()
...
//        print(itemsDataSource.items)
//        print(guestsDataSource.guests)
...
//        self.guestsTableView.reloadData()
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.itemsDataSource?.delegate = guestsDataSource
        self.guestsDataSource?.delegate = self
        
        self.itemsTableView.delegate = itemsDataSource
        self.guestsTableView.delegate = guestsDataSource
