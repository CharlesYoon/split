...
class HomeViewController: UIViewController, RescanDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
...
//        spinner.hidesWhenStopped = true
    ...
    @IBAction func scanImageButtonTapped(_ sender: UIButton) {
    ...
    func didClickRescan() {
        scanImageButtonTapped(scanButton)
    }
}
